...
/**
 * The Class DBPropertiesGRP4.
 *
 * @author Groupe 4
 */
class DBPropertiesGRP4 extends Properties {
	 ...
	 */
	public DBPropertiesGRP4() {
		InputStream inputStream;

		inputStream = this.getClass().getClassLoader().getResourceAsStream(DBPropertiesGRP4.PROPERTIES_FILE_NAME);
